...
#define		WIDGET_ID		1012

#define		UM_CONFIG_OPTION		WM_USER + 101
#define		UM_TRANSPARENT			WM_USER + 102
#define		UM_STOP_PLAYER			WM_USER + 103
#define		UM_SHOW_TOP				WM_USER + 104

#define		PLAYER_INIT_TEXT		_T("선택한 곡이 없습니다.")
